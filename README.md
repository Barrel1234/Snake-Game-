# Snake-Game-
Snake Game made with C++ and SFML.
...
12.copy and paste the Snake Game.cpp inside the editor.

13.copy and paste the images folder inside the second folder of the Snake Game folder.
